...
| Task | Description | Domain | Wave | Status | Branch | Dependencies |
|------|-------------|--------|------|--------|--------|-------------|
| task_02 | Config system (YAML loader + Pydantic) | backend | 2 | 🔲 todo | task/02-config | 01 |
| task_03 | SQLite schema + migrations + queries | backend | 2 | 🔲 todo | task/03-database | 01 |
| task_04 | LLM provider abstraction | backend | 2 | 🔲 todo | task/04-llm-providers | 01 |
| task_05 | Base ingestor interface + content extractor | backend | 2 | 🔲 todo | task/05-base-ingestor | 01 |
...
| task_32 | Dashboard scaffolding (Vite + Tailwind + shadcn) | frontend | 13 | 🔲 todo | task/32-dashboard-scaffold | none |
